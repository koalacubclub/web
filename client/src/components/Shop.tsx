...
// The shop **bottom sheet**: a carousel of buyable decorations rendered as their
// real art. Buying spends the game score (coins) and spawns the item at Koala's
// tile. The sheet only covers the bottom of the screen and adds **no backdrop
// dim/blur**, so the park stays visible + interactive above it. It's a controlled
// component — the trigger lives in the BottomBar (grouped with score + settings).
