/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 58c007d772cb21846695e6636a081150)
// Runtime types generated with workerd@1.20260815.1 2025-02-01
interface __BaseEnv_Env {
  ENVIRONMENT: 'production' | 'development'
  ALLOWED_ORIGINS:
    | 'https://www.koalacub.club,https://koalacub.club'
    | 'http://localhost:5173,http://localhost:4173'
  GAME_WORLD: DurableObjectNamespace<import('./src/worker').GameWorld>
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/worker')
    durableNamespaces: 'GameWorld'
  }
